...
/**
 * This class represents any items, message or task. Since an item can hahve
 * different form, this class is abstract.
 *
 * @author durban
 */
public abstract class Item {
    ...
    /**
     * Basic constructor of an item with only its header. Creates empty
     * recipients and attachments list.
     *
    ...
    /**
     * Basic constructor of an item with nothing. Creates empty recipients and
     * attachments list.
     */
    public Item() {
        this.recipients = new ArrayList<Recipient>();
    ...
    /**
     * Sets the creation date of the item given the stringified version with
    ...
    /**
     * Add a list of attachments to the list.
     *
     * @param atts attachments to add.
     */
    public void addAttachments(ArrayList<Attachment> atts) {
        if (this.getAttachmentsCount() == 0) {
            this.header.setHasAttachments(true);
        }
        this.getAttachments().addAll(atts);
    }
