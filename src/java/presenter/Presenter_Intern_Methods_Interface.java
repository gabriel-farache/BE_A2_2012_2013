...
public interface Presenter_Intern_Methods_Interface {
     ...
     *
     * @param token The token of the session
     * @param onlyUserTasks TRUE : gets only all the headers' tasks of the user, FALSE : get all tasks header
     ...
     *
     * @param token The token of the session
     * @param received TRUE : gets the received messages, FALSE : gets the send messages
    ...
    /**
     * Gets all the tasks of a member as a String. Each task is separated with a comma.
     * @param id_member The ID of the member to get the tasks
     * @return  The tasks of a member as a String. Each task is separated with a comma.
     */
    @WebMethod(operationName = "getMemberTasks")
    public String getMemberTasks(String id_member);
    
    /**
     * Gets all the groups of a member as a String. Each group is separated with a comma.
     * @param id_member The ID of the member to get the tasks
     * @return The groups of a member as a String. Each group is separated with a comma.
     */
