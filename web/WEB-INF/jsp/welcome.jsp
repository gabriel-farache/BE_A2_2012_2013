    ...
    <body>
            ...
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <a href="connection"><input type="button" class="btn btn-danger pull-right" value="D&eacute;connexion"/></a>
                            <%} else {%>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                    ...
                    <div class="well sidebar-nav-fixed">
                        <ul class="nav nav-list">
                            <li class="nav-header dropdown">
                                <a id="drop2" href="#" role="button" class="dropdown-toggle" data-toggle="dropdown">Mes t&acirc;ches <b class="caret"></b></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="drop1">
                                    <li><a tabindex="-1" href="inbox">Bo&icirc;te de r&eacute;c&eacute;ption</a></li>
                                    <li><a tabindex="-1" href="createMessage">Envoyer un message</a></li>
                                </ul>
                            ...
                            <li class="nav-header dropdown">
                                <a id="drop2" href="#" role="button" class="dropdown-toggle" data-toggle="dropdown">Utilisateurs <b class="caret"></b></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="drop1">
                                    <li><a tabindex="-1" href="inbox">Bo&icirc;te de r&eacute;c&eacute;ption</a></li>
                                    <li><a tabindex="-1" href="createMessage">Envoyer un message</a></li>
                                </ul>
                            ...
                            <li class="nav-header dropdown">
                                <a id="drop2" href="#" role="button" class="dropdown-toggle" data-toggle="dropdown">Groupes <b class="caret"></b></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="drop1">
                                    <li><a tabindex="-1" href="inbox">Bo&icirc;te de r&eacute;c&eacute;ption</a></li>
                                    <li><a tabindex="-1" href="createMessage">Envoyer un message</a></li>
                                </ul>
                ...
                </div><!--/span--><link href="<c:url value="/css/bootstrap.css"/>" rel="stylesheet">
                <style type="text/css">
                    body {
                        padding-top: 60px;
                        padding-bottom: 40px;
