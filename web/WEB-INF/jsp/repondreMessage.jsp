                ...
                <div class="box">
                    <div class="blog_box">
                        ...
                        <div class="text">
                            ...
                            <div id="box_form">
                                <form method="post" name="saisieNouveauMessage" id="saisieNouveauMessage" action="<c:url value="adminListOfMessages"/>">
                                    ...
                                    <fieldset>
                                        ...
                                        <input type="button" class="submit_but" name="selectGroupeDestinataire" id="selectGroupeDestinataire" value="Choisir Groupe(s)" onclick="window.open('chooseGroupToSendFileTo', 'exemple', 'height=600, width=800, top=90, left=350, toolbar=no, menubar=no, location=yes, resizable=yes, scrollbars=yes, status=no');"/>
                                        <input type="button" class="submit_but" name="selectUtilisateurDestinataire" id="selectUtilisateurDestinataire" value="Choisir Utilisateur(s)" onclick="window.open('chooseuserToSendFileTo', 'exemple', 'height=600, width=800, top=90, left=350, toolbar=no, menubar=no, location=yes, resizable=yes, scrollbars=yes, status=no');"/>
                                        </br></br>
                                        <div class="form_line">
                                            <input type="text" class="input" name="saisieGroupeDestinataire" id="saisieGroupeDestinataire" value="1 " required />
                                        </div>
                                        <div class="form_line">
                                            <input type="text" class="input" name="saisieUtilisateurDestinataire" id="saisieUtilisateurDestinataire" value="toto" required />
                                        </div>
                                    </fieldset>
