<%-- 
    Document   : CheckGroup
    Created on : 14 janv. 2013, 11:17:40
    Author     : Doudi
--%>
                    ...
                    <article>
                        ...
                        <form id="selectUsersForm" action="<c:url value="checkGroup"/> method="post" ></br>
                            ...
                            <fieldset>
                                ...
                                <input type="submit" name="listeMembresDisponibles " id="listeMembresDisponibles " class="submit_but" Value="Ajouter membre(s)" formaction="<c:url value="checkGroupWithListOfAvailableGroupMembers.jsp"/>" /></br></br></br>
