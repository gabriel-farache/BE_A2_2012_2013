                    ...
                    <div class="blog_box">
                        ...
                        <div class="text">
                            ...
                            <article>
                                ...
                                <form action="<c:url value="checkGroup"/>" method="post" ></br>
                                    ${listeDesGroupes}
                                    </br></br>
                                    <input type="submit" class="submit_but" value="Afficher les membres" />
                                </form></br>
                                <input type="submit" class="submit_but" value="Créer" href="createGroup" />
