...
<html>
    <head>
        ...
        <jsp:include page="header.jsp" >
            <jsp:param name="title" value="PESO - Consultation des tâches" />
        </jsp:include>
        <!-- fin header -->
    </head>
    <body>
		...
		<div id="content" >
                <jsp:include page="menu.jsp" >
                        ...
                        <jsp:param name="tâchesMenu" value="class=\"but_now\"" />
        ...
        <div id="right_blog">    	
            <div class="box">
                <div class="blog_box">
                    ...
                    <input type="${display}" class="submit_but" value="Créer une tâche"  href="CreateTask" />
